                    ...
                    HudSplitView {
                        ...
                        HudPanel {
                            ...
                            GridLayout {
                                ...
                                columnSpacing: 6
                                rowSpacing: 6
                                VitalTile { Layout.fillWidth: true; glyph: "♨"; label: "BODY TEMP"; value: vitalsPanel.live ? String(vitalsPanel.t.temperature_c_text || "—") : "—"; unit: vitalsPanel.live ? String(vitalsPanel.t.temperature_f_text || "") : ""; tone: root.accent; stale: vitalsPanel.stale; live: vitalsPanel.live }
                                VitalTile { Layout.fillWidth: true; glyph: "◉"; label: backend.selectedDevice.camera === "wide" ? "WIDE SENSOR" : "TELE SENSOR"; value: vitalsPanel.live ? String((backend.selectedDevice.camera === "wide" ? vitalsPanel.t.cmos_wide_c_text : vitalsPanel.t.cmos_tele_c_text) || "—") : "—"; unit: vitalsPanel.live ? String((backend.selectedDevice.camera === "wide" ? vitalsPanel.t.cmos_wide_f_text : vitalsPanel.t.cmos_tele_f_text) || "") : ""; tone: root.notice; stale: vitalsPanel.stale; live: vitalsPanel.live }
